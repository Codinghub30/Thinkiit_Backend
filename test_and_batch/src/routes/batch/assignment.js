...
const assignmentController = require("../../controllers/batch/assignmentController");
...
const uploadToS3 = async (req, res, next) => {
  try {
    ...
    const uploadParams = {
      ...
      Key: `assignment/${Date.now()}-${file.originalname}`,
      Body: file.buffer,
...
router.get("/:classId", assignmentController.getAssignmentsByClass);
router.get(
  "/subject/:subjectName",
